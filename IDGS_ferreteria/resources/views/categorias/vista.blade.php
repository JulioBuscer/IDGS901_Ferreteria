    ...
    <div class="m-5">
        ...
        <div class="tab-content mb-3" id="ex2-content">
            <div class="tab-pane fade show active" id="ex3-tabs-1" role="tabpanel" aria-labelledby="ex3-tab-1">
                ...
                <hr class="hr-245">
                <table name="tableCaracteristicas" id="tableCaracteristicas">
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <button class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#exampleModal1"
                                        onclick="verCategorias('{{ $row->id }}','{{ $row->nombre }}','{{ $row->descripcion }}')">
                                        <i class="fas fa-eye"></i> </button>

                                    <button class="btn btn-success" data-mdb-toggle="modal" data-mdb-target="#exampleModal"
                                        onclick="editarCategorias('{{ $row->id }}','{{ $row->nombre }}','{{ $row->descripcion }}')">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#tableCaracteristicas').DataTable();
        });
    </script>
@endpush
