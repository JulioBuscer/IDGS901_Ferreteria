...
<div class="m-5 ">
    ...
    <div class="tab-content d-flex align-items-center justify-content-center" id="ex2-content">
        <div class="tab-pane fade show active" id="ex3-tabs-1" role="tabpanel" aria-labelledby="ex3-tab-1">
            ...
            <hr class="hr-245">
            <table class="table table-responsive text-justify" name="tablaProductosActivos" id="tablaProductosActivos">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#exampleModal1"
                                onclick="verProductos('{{ $row->id }}','{{ $row->nombre }}','{{ $row->descripcion }}','{{ $row->precio }}','{{ $row->cantidad }}','{{ $row->unidad }}','{{ $row->fotografia }}','{{ $row->idCategoria }}')">
                                <i class="fas fa-eye"></i> </button>
                            <button class="btn btn-success" data-mdb-toggle="modal" data-mdb-target="#exampleModal"
                                onclick="editarProductos('{{ $row->id }}','{{ $row->nombre }}','{{ $row->descripcion }}','{{ $row->precio }}','{{ $row->cantidad }}','{{ $row->unidad }}','{{ $row->fotografia }}','{{ $row->idCategoria }}')">
        ...
        <div class="tab-pane fade" id="ex3-tabs-2" role="tabpanel" aria-labelledby="ex3-tab-2">
            ...
            <hr class="hr-245">
            <table class="table table-responsive text-justify" name="tablaProductosInactivos"
                id="tablaProductosInactivos">
                <thead class="table-dark text-center">
                    <th>Fotografia</th>
                    <th>Id</th>
                    <th>Nombre Producto</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#exampleModal1"
                                onclick="verProductos('{{ $row2->id }}','{{ $row2->nombre }}','{{ $row2->descripcion }}','{{ $row2->precio }}','{{ $row2->cantidad }}','{{ $row2->unidad }}','{{ $row2->fotografia }}','{{ $row2->idCategoria }}')">
                                <i class="fas fa-eye"></i> </button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" id=editCat>
                <input class="form-control active" name="_method" type="hidden" value="PUT">
                @csrf
                <input class="form-control active"  name="idProd" style="display:none;" id="idProd" />
                <div class="modal-body">
                    <!-- -->
                    <div class="row">
                        <div class="col form-outline m-2">
                            <input type="text" name="nombreProducto0" id="nombreProducto0"
                                class="form-control active" />
                            <label class="form-label" for="nombreProducto0">Nombre Producto</label>
                        </div>
                        <div class="col form-outline m-2">
                            <input type="text" name="txtDescripcion0" id="txtDescripcion0"
                                class="form-control active" />
                    ...
                    <div class="row">
                        <div class="col form-outline m-2">
                            <input type="number" name="txtPrecio0" id="txtPrecio0" class="form-control active" />
                            <label class="form-label" for="txtPrecio0">Precio</label>
                        </div>
                        <div class="col form-outline m-2">
                            <input type="text" name="txtCantidad0" id="txtCantidad0" class="form-control active"
                                readonly />
                            <label class="form-label" for="txtCantidad0">Cantidad</label>
                        </div>
                        <div class="col form-outline  m-2">
                            <input type="text" name="txtUnidad0" id="txtUnidad0" class="form-control active" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col m-2">
                        <select name="slcCategoria11" id="slcCategoria11" class="form-select" disabled
                            aria-label="Default select example">
                            <option disabled selected>Categoria</option>
                            @forelse($select as $slc)
                            <option value="{{ $slc->id }}">{{ $slc->nombre }}</option>
                ...
                <div class="row">
                    <div class="col form-outline m-2">
                        <input type="number" name="txtPrecio1" id="txtPrecio1" class="form-control active" readonly />
                        <label class="form-label" for="txtPrecio1">Precio</label>
                    </div>
                    <div class="col form-outline m-2">
                        <input type="text" name="txtCantidad1" id="txtCantidad1" class="form-control active" readonly />
                        <label class="form-label" for="txtCantidad1">Cantidad</label>
                    </div>
                    <div class="col form-outline  m-2">
                        <input type="text" name="txtUnidad1" id="txtUnidad1" class="form-control active" readonly />
