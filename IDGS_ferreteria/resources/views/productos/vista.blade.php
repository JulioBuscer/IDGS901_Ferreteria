                                ...
                                <div class="col form-outline ml-2">
                                    ...
                                    <div class="file-field input-field">
                                        ...
                                        <div class="btn waves-effect waves-red orange accent-4 btn-large ">
                                            ...
                                            <img src="{{ asset('img/upload.jpg') }}" id="imgFoto2" height="200"
                                                width="200">
                    ...
                    <div class="row">
                        <div class="col form-outline m-2 text-center">
                            ...
                            <div class="row">
                                ...
                                <input type="file" name="txtFoto20" id="txtFoto20" class="form-control text-black orange"
                                    onchange="actualizarFotoProducto();">
