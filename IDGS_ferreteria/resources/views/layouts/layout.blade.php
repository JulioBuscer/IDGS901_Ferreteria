...
<body class="homepage-v1 hidden-sn white-skin animated">
    ...
    <body class="homepage-v1 hidden-sn white-skin animated" onload="getNotificationsCount({{\Auth::user()->id}})">
        @endguest
                                            ...
                                            <ul class="dropdown-menu dropdown-menu"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ URL::to('notifications') }}">Notificaciones
                                ...
                                <div class="container">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            @endif
                                            @if(\Auth::user()->id_rol == 3 or \Auth::user()->id_rol == 1 or \Auth::user()->id_rol == 2)   
                                            <li class="nav-item">
                                                <a class="nav-link waves-effect waves-light white-text font-weight-bold"
                                            ...
                                            @if(\Auth::user()->id_rol == 3 or \Auth::user()->id_rol == 1)
                                            
                                            <li class="nav-item">
                                                <a class="nav-link waves-effect waves-light white-text font-weight-bold"
                                                    href="{{ URL::to('venta_terminada') }}">
                                                    Ventas
                                                    <span class="sr-only">(current)</span>
                                                </a>
                                            </li>
        ...
        <script src="https://cdn.datatables.net/1.10.25/js/jquery.dataTables.min.js" crossorigin="anonymous"
