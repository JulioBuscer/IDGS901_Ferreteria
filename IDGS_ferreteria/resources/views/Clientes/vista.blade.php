    ...
    <div class="m-5 ">
        ...
        <div class="tab-content d-flex align-items-center justify-content-center" id="ex2-content">
            <div class="tab-pane fade show active" id="ex3-tabs-1" role="tabpanel" aria-labelledby="ex3-tab-1">
                ...
                <hr class="hr-245">
                <table class="text-justify" name="tblClientesActivos" id="tblClientesActivos">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#exampleModal1"
                                        onclick="verCliente('{{ $row->id }}','{{ $row->nombre }}','{{ $row->apellidoP }}','{{ $row->apellidoM }}','{{ $row->rfc }}','{{ $row->direccion }}','{{ $row->correo }}','{{ $row->idPersona }}','{{ $row->telefono }}')">
                                        <i class="fas fa-eye"></i> </button>
                                    <button class="btn btn-success" data-mdb-toggle="modal" data-mdb-target="#exampleModal"
                                        onclick="editarCliente('{{ $row->id }}','{{ $row->nombre }}','{{ $row->apellidoP }}','{{ $row->apellidoM }}','{{ $row->rfc }}','{{ $row->direccion }}','{{ $row->correo }}','{{ $row->idPersona }}','{{ $row->telefono }}')">
            ...
            <div class="tab-pane fade" id="ex3-tabs-2" role="tabpanel" aria-labelledby="ex3-tab-2">
                ...
                <hr class="hr-245">
                <table class="text-justify" name="tblClientesInactivos" id="tblClientesInactivos">
                    <thead class="table-dark text-center">
                        <th>Id</th>
                        <th>Nombre</th>
                        <th>RFC</th>
                    ...
                    <tbody>
                        @forelse($table2 as $row2)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary" data-mdb-toggle="modal" data-mdb-target="#exampleModal1"
                                        onclick="verCliente('{{ $row2->id }}','{{ $row2->nombre }}','{{ $row2->apellidoP }}','{{ $row2->apellidoM }}','{{ $row2->rfc }}','{{ $row2->direccion }}','{{ $row2->correo }}','{{ $row2->idPersona }}','{{ $row2->telefono }}')">
                                        <i class="fas fa-eye"></i> </button>
            ...
            <div class="modal-content">
                ...
                <form method="POST" id=editCat>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col form-outline  m-2">
                                <input type="email" name="email1" autocomplete="off" value="" id="email1"
                                    class="form-control" />
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col form-outline  m-2">
                            <input type="email" name="email2" autocomplete="off" value="" id="email2" class="form-control"
                                disabled />
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#tblClientesInactivos').DataTable();
        });
    </script>
@endpush
